# Malastare AI
# Data Analytics Team: Mathew Hart, Joey Spreitler, Rihad Variawa
# FinTech
...
# CredX is a leading credit card provider that gets millions of credit card applicants each year. 
# However, in the past few years, it has experienced an increase in credit loss. The CEO believes that 
...
# There are two datasets for this project - demographic and credit bureau data. 
...
# Demographic/application data: This is obtained from the information provided by the applicants at the
# time of credit card application. 
...
# In this project, we'll help CredX identify the right customers using predictive models. 
# Using descriptive analaytics of the bank's applicants, we will determine the factors affecting credit risk, 
# create strategies to mitigate the acquisition risk and assess the financial benefit for CredX

#------------------------------------------------------------------
## Note - that these datasets are anonymised for copyright purposes
#------------------------------------------------------------------
