...
response = {
    ...
    "card_limit":["By using your card you can withdraw maximum 30,000 and minimum 500 in one day with maximum 5 transactions"],
    "credit_card_limit":["You can spend total 50,000 with your credit card"],
