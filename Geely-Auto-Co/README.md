...
Recommendation (vehicle manufacturing etc.)

## Data science problem

To understand the factors on which the pricing of a motor vehicle depends.

## Approach

Supervised Linear Machine Learning Task
