...
#Checking the duplicate "car_ID" and row
...
## Linear regression comes under predictive analysis and is used to find the relationship between two variables.
## These two variables are the target variable and the predictor variable. The dependent variable is the target variable
## and the independent variable is the predictor variable. Both of these variables are features that already exist in adataset.

## The overall concept of regression is to check two things- does the given group of predictor variables do a satisfactory
## job in predicting the dependent variable? And which variables, in particular, are the real predictors of the
## dependent variable, and what is the impact the outcome variable?
...
#Create training set and taking 70% of the data for training
